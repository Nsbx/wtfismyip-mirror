...
curl --user-agent "wtfdnsapi v0.1" https://api.cloudns.net/dns/failover-activate.json?"auth-id=$CLOUDNS_AUTH_ID&auth-password=$CLOUDNS_AUTH_PASSWORD&domain-name=wtfismyip.com&record-id=256189575&check_type=4&host=wtfismyip.com&port=80&path=test&down_event_handler=2&up_event_handler=1&main_ip=$NA6&backup_ip_1=$BA6&&check_period=60&backup_ip_2=$BA62" ; echo " ; echo "
...
curl --user-agent "wtfdnsapi v0.1" https://api.cloudns.net/dns/failover-activate.json?"auth-id=$CLOUDNS_AUTH_ID&auth-password=$CLOUDNS_AUTH_PASSWORD&domain-name=wtfismyip.com&record-id=256189596&check_type=4&host=wtfismyip.com&port=80&path=test&down_event_handler=2&up_event_handler=1&main_ip=$NA4&backup_ip_1=$BA4&&check_period=60&backup_ip_2=$BA42" ; echo " ; echo "
...
curl --user-agent "wtfdnsapi v0.1" https://api.cloudns.net/dns/failover-activate.json?"auth-id=$CLOUDNS_AUTH_ID&auth-password=$CLOUDNS_AUTH_PASSWORD&domain-name=wtfismyip.com&record-id=256189599&check_type=4&host=wtfismyip.com&port=80&path=test&down_event_handler=2&up_event_handler=1&main_ip=$NA6&backup_ip_1=$BA6&&check_period=60&backup_ip_2=$BA62" ; echo " ; echo "
...
curl --user-agent "wtfdnsapi v0.1" https://api.cloudns.net/dns/failover-activate.json?"auth-id=$CLOUDNS_AUTH_ID&auth-password=$CLOUDNS_AUTH_PASSWORD&domain-name=myip.wtf&record-id=256189643&check_type=4&host=wtfismyip.com&port=80&path=test&down_event_handler=2&up_event_handler=1&main_ip=$NA4&backup_ip_1=$BA4&&check_period=60backup_ip_2=$BA42&" ; echo " ; echo "
...
curl --user-agent "wtfdnsapi v0.1" https://api.cloudns.net/dns/failover-activate.json?"auth-id=$CLOUDNS_AUTH_ID&auth-password=$CLOUDNS_AUTH_PASSWORD&domain-name=myip.wtf&record-id=256189645&check_type=4&host=wtfismyip.com&port=80&path=test&down_event_handler=2&up_event_handler=1&main_ip=$NA6&backup_ip_1=$BA6&&check_period=60&backup_ip_2=$BA62" ; echo " ; echo "
