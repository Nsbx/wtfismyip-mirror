...
func main() {
	...
	r.HandleFunc("/", cleanHandle).Host("clean.myip.wtf")
	r.HandleFunc("/json", cleanjson).Host("clean.myip.wtf")
	r.HandleFunc("/", cleanHandle).Host("c.myip.wtf")
	r.HandleFunc("/json", cleanjson).Host("c.myip.wtf")
